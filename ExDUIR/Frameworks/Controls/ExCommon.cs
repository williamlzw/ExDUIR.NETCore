...
namespace ExDuiR.NET.Frameworks.Controls
{
            ...
            set
            {
                ...
                for (int i = 0; i < polygonArr.count; i++)
                {
                    ...
                    for (int j = 0; j < points.Count; j++)
                    {
                        ...
                        IntPtr targetPtrX = IntPtr.Add(polygon.points, j * 8);
                        IntPtr targetPtrY = IntPtr.Add(polygon.points, j * 8 + 4);
                        Marshal.StructureToPtr(x, targetPtrX, true);
                        Marshal.StructureToPtr(y, targetPtrY, true);
                    }
    ...
    public class ExCircleProgressBar : ExControl
    {
        ...
        public int Pos
        {
            ...
            set
            {
                this.SetLong(CIRCLEPROGRESSBAR_LONG_POS, value);
            }
        }
        ...
        public int Range
        {
            ...
            set
            {
                this.SetLong(CIRCLEPROGRESSBAR_LONG_RANGE, value);
            }
        }
        ...
        public int LineCap
        {
            ...
            set
            {
                this.SetLong(CIRCLEPROGRESSBAR_LONG_LINECAP, value);
            }
        }
        ...
        public int LineHeight
        {
            ...
            set
            {
                this.SetLong(CIRCLEPROGRESSBAR_LONG_LINEHEIGHT, value);
            }
        }
        ...
        public ExFont Font
        {
            ...
            set
            {
                this.SetLong(CIRCLEPROGRESSBAR_LONG_FONT, value.handle);
            }
        }
        ...
        public int BackgroundColor
        {
            ...
            set
            {
                this.SetLong(CIRCLEPROGRESSBAR_LONG_BACKGROUNDCOLOR, value);
            }
        }
        ...
        public int ForegroundColor
        {
            ...
            set
            {
                this.SetLong(CIRCLEPROGRESSBAR_LONG_FOREGROUNDCOLOR, value);
            }
        }
    ...
    public class ExWaveProgressBar : ExControl
    {
        ...
        public int Pos
        {
            ...
            set
            {
                this.SetLong(WAVEPROGRESSBAR_LONG_POS, value);
            }
        }
        ...
        public int WaveWidth
        {
            ...
            set
            {
                this.SetLong(WAVEPROGRESSBAR_LONG_WAVE_WIDTH, value);
            }
        }
        ...
        public int WaveHeight
        {
            ...
            set
            {
                this.SetLong(WAVEPROGRESSBAR_LONG_WAVE_HEIGHT, value);
            }
        }
        ...
        public int LeftX
        {
            ...
            set
            {
                this.SetLong(WAVEPROGRESSBAR_LONG_LEFT_X, value);
            }
        }
        ...
        public ExFont Font
        {
            ...
            set
            {
                this.SetLong(WAVEPROGRESSBAR_LONG_FONT, value.handle);
            }
        }
        ...
        public int BackgroundColor
        {
            ...
            set
            {
                this.SetLong(WAVEPROGRESSBAR_LONG_BACKGROUNDCOLOR, value);
            }
        }
        ...
        public int ForegroundColor
        {
            ...
            set
            {
                this.SetLong(WAVEPROGRESSBAR_LONG_FOREGROUNDCOLOR, value);
            }
        }
    ...
    public class ExLineChart : ExControl
    {
        ...
        public int SetValue
        {
            set
            {
                this.SendMessage(LINECHART_MESSAGE_SETVALUE, IntPtr.Zero, value);
            }
        }
        ...
        public int SetBackgroundColor
        {
            set
            {
                this.SendMessage(LINECHART_MESSAGE_BACKGROUNDCOLOR, IntPtr.Zero, value);
            }
        }
        ...
        public int SetForegroundColorFill
        {
            set
            {
                this.SendMessage(LINECHART_MESSAGE_FOREGROUNDCOLOR_FILL, IntPtr.Zero, value);
            }
        }
        ...
        public int SetForegroundColorDraw
        {
            set
            {
                this.SendMessage(LINECHART_MESSAGE_FOREGROUNDCOLOR_DRAW, IntPtr.Zero, value);
            }
        }
    ...
    public class ExChatBox : ExControl
    {
        ...
        public ExImage UserImg
        {
            set
            {
                this.SendMessage(CHATBOX_MESSAGE_SETIMAGE_USER, IntPtr.Zero, value.handle);
            }
        }
        ...
        public ExImage AssistantImg
        {
            set
            {
                this.SendMessage(CHATBOX_MESSAGE_SETIMAGE_ASSISTANT, IntPtr.Zero, value.handle);
            }
        }
