    ...
    static class ButtonExWindow
    {
        ...
        static public void CreateButtonExWindow(ExSkin pOwner)
        {
            ...
            if (skin.Validate)
            {
                ...
                var connect = File.ReadAllBytes("Resources/connect.png");
                ExImage img = new ExImage(connect, connect.Length);
                button4.Icon = img;

                button5 = new ExButtonEx(skin, "", 50, 250, 100, 30);
                var buttonnormalimg = File.ReadAllBytes("Resources/buttonnormal.png");
                var buttonhoverimg = File.ReadAllBytes("Resources/buttonhover.png");
                var buttondownimg = File.ReadAllBytes("Resources/buttondown.png");
                var buttonnormal = new ExImage(buttonnormalimg, buttonnormalimg.Length);
                var buttonhover = new ExImage(buttonhoverimg, buttonhoverimg.Length);
                var buttondown = new ExImage(buttondownimg, buttondownimg.Length);
                ...
                var buttonnormalimg2 = File.ReadAllBytes("Resources/button2normal.png");
                var buttonhoverimg2 = File.ReadAllBytes("Resources/button2hover.png");
                var buttondownimg2 = File.ReadAllBytes("Resources/button2down.png");
                var buttonnormal2 = new ExImage(buttonnormalimg2, buttonnormalimg2.Length);
                var buttonhover2 = new ExImage(buttonhoverimg2, buttonhoverimg2.Length);
                var buttondown2 = new ExImage(buttondownimg2, buttondownimg2.Length);
                ...
                var iconimg = File.ReadAllBytes("Resources/icon.png");
                var icon = new ExImage(iconimg, iconimg.Length);
                button9.Icon = icon;
                ...
                var icon2img = File.ReadAllBytes("Resources/icon2.png");
                var icon2 = new ExImage(icon2img, icon2img.Length);
                button10.Icon = icon2;
