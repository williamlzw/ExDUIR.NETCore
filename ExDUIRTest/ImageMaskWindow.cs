    ...
    static class ImageMaskWindow
    {
        ...
        static public void CreateImageMaskWindow(ExSkin pOwner)
        {
            ...
            if (skin.Validate)
            {
                ...
                label = new ExStatic(skin, "", 50, 50, 200, 200, -1, -1, -1, 0, 0, objProc);
        ...
        static public IntPtr OnLabelMsgProc(IntPtr hWnd, int hObj, int uMsg, IntPtr wParam, IntPtr lParam, IntPtr pResult)
        {
            ...
            {
                var data1 = File.ReadAllBytes("Resources/mask4.jpg");
                var image1 = new ExImage(data1, data1.Length);
                var data2 = File.ReadAllBytes("Resources/mask1.png");
                var image2 = new ExImage(data2, data2.Length);
