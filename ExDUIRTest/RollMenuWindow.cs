    ...
    static class RollMenuWindow
    {
        ...
        static public void CreateRollMenuWindow(ExSkin pOwner)
        {
            ...
            if (skin.Validate)
            {
                ...
                var accountimg = File.ReadAllBytes("Resources/account.png");
                var videoimg = File.ReadAllBytes("Resources/video.png");
                var infoimg = File.ReadAllBytes("Resources/info.png");
                var fansimg = File.ReadAllBytes("Resources/fans.png");
                var authorizationimg = File.ReadAllBytes("Resources/authorization.png");
                var accountIndex = imglist.AddImage(new ExImage(accountimg, accountimg.Length), 0);
                var videoIndex = imglist.AddImage(new ExImage(videoimg, videoimg.Length), 0);
                var infoIndex = imglist.AddImage(new ExImage(infoimg, infoimg.Length), 0);
                var fansIndex = imglist.AddImage(new ExImage(fansimg, fansimg.Length), 0);
                var authorizationIndex = imglist.AddImage(new ExImage(authorizationimg, authorizationimg.Length), 0);
                List<int> emoji = new List<int>();

                var nav1img = File.ReadAllBytes("Resources/nav1.png");
                var nav2img = File.ReadAllBytes("Resources/nav2.png");
                var nav3img = File.ReadAllBytes("Resources/nav3.png");
                var nav4img = File.ReadAllBytes("Resources/nav4.png");
                var index1 = imglist.AddImage(new ExImage(nav1img, nav1img.Length), 0);
                emoji.Add(index1);
                var index2 = imglist.AddImage(new ExImage(nav2img, nav2img.Length), 0);
                emoji.Add(index2);
                var index3 = imglist.AddImage(new ExImage(nav3img, nav3img.Length), 0);
                emoji.Add(index3);
                var index4 = imglist.AddImage(new ExImage(nav4img, nav4img.Length), 0);
                emoji.Add(index4);
